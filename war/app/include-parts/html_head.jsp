...
%>
	...
	<!-- Prettyphoto -->
	<link rel="stylesheet" href="/app/css/prettyPhoto.css">
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="/app/css/owl.carousel.css">
	<link rel="stylesheet" href="/app/css/owl.theme.css">
	<!-- Flexslider -->
	<link rel="stylesheet" href="/app/css/flexslider.css">
	<!-- Flexslider -->
	<link rel="stylesheet" href="/app/css/cd-hero.css">
	<!-- Style Swicther -->
<!-- 	<link id="style-switch" href="/app/css/presets/preset3.css" media="screen" rel="stylesheet" type="text/css"> -->
	<!-- Style Custom -->
