                        ...
                        <div class="feature-wrap">
                            ...
                            <h2>
								<a data-toggle="modal" 
									...
									<span id="<%=Utils.getResKey(item.getKey().getName(), TextResIds.T002_LIST_ITEM_TYPE001_001) %>"><%=TextResIds.T002_LIST_ITEM_TYPE001_001.getDefaultValue() %></span>
								</a>
                            </h2>
                            <h3>
                            	<a data-toggle="modal" 
									...
									<span id="<%=Utils.getResKey(item.getKey().getName(), TextResIds.T002_LIST_ITEM_TYPE001_002) %>"><%=TextResIds.T002_LIST_ITEM_TYPE001_001.getDefaultValue() %></span>
								</a>
                            </h3>
                        </div>
                    </div><!--/.col-md-4-->
