							...
							<div class="col-md-4 ss2-content text-center">
								...
								<h4>
									<a data-toggle="modal" 
										...
										<span id="<%=Utils.getResKey(item.getKey().getName(), TextResIds.T001_LIST_ITEM_TYPE003_001) %>"><%=TextResIds.T001_LIST_ITEM_TYPE003_001.getDefaultValue() %></span>
									</a>
								</h4>
								<p>
									<a data-toggle="modal" 
										...
										<span id="<%=Utils.getResKey(item.getKey().getName(), TextResIds.T001_LIST_ITEM_TYPE003_002) %>"><%=TextResIds.T001_LIST_ITEM_TYPE003_002.getDefaultValue() %></span>
									</a>
								</p>
							</div>
